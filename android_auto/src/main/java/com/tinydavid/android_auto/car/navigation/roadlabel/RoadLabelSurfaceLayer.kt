package com.tinydavid.android_auto.car.navigation.roadlabel
...
import com.tinydavid.android_auto.surface_layer.textview.CarTextLayerHost
...
class RoadLabelSurfaceLayer(
    ...
    private val roadNameObserver =
        object : RoadNameObserver(mapboxNavigation, routeShieldApi, mapboxCarMap) {
